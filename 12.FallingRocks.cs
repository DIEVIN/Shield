...
class FallingRocks
{
    ...
    static void Main()
    {
        ...
        Console.WriteLine();
        Console.WriteLine("You are a mighty dwarf from the great clan Wildhammer. You fell from your gryphon during the War Of The Three Hammers.");
        Console.WriteLine(@"You need to climb the hill to get your gryphon,avoiding getting hit by any of the
falling rocks.");
        Console.WriteLine(
